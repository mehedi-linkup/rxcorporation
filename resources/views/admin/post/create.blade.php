            ...
            <div class="page-title-box">
                ...
                <div class="state-information d-none d-sm-block">
                    <div class="state-graph">
                        ...
                        <div class="info"><a href="{{route('post.index')}}" class="btn btn-primary">Post List</a></div>
                    </div>
                    <div class="state-graph">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <textarea id="aboutEditor"  name="short_details" rows="10" placeholder="short Description"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
