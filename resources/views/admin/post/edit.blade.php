            ...
            <div class="page-title-box">
                ...
                <div class="state-information d-none d-sm-block">
                    <div class="state-graph">
                        ...
                        <div class="info"><a href="{{route('post.index')}}" class="btn btn-primary">Back</a></div>
                    </div>
                    <div class="state-graph">
    ...
    <div class="row justify-content-center">
        <div class="col-lg-12">
            <div class="card m-b-20">
                <div class="card-body">
                    <form action="{{route('post.update',$post->slug)}}" method="post" enctype="multipart/form-data" id="postForm">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input  name="date" type="date" value="{{$post->date}}"  class="form-control"  />
                                   </div>
                                </div>
                                <div class="form-group">
                                    <label>Short details <span class="text-primary">*</span></label>
                                    <div>
                                        <textarea id="aboutEditor"  name="short_details" rows="10" placeholder="short Description">{{$post->short_details}}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
...
<script> 
    function aboutUrl(input) {
        ...
        document.getElementById("previewImage").src="{{asset($post->image)}}";
