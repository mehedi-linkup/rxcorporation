            ...
            <div class="page-title-box">
                ...
                <div class="state-information d-none d-sm-block">
                    <div class="state-graph">
                        ...
                        <div class="info"><a href="{{route('category.index')}}" class="btn btn-primary">Back</a></div>
                    </div>
                    <div class="state-graph">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label>Name</label>
                                    <div>
                                        <input  name="name" type="text" value="{{$category->name}}"  class="form-control" id="name"  placeholder="Enter Title"/>
