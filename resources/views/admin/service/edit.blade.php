    ...
    <div class="row justify-content-center">
        <div class="col-lg-12">
            <div class="card m-b-20">
                <div class="card-body">
                    <form action="{{route('service.update',$service->id)}}" method="post" enctype="multipart/form-data" id="postForm">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input  name="title" type="text" value="{{$service->title}}"  class="form-control"  placeholder="Enter Title"/>
                                   </div>
                                </div>
                                <div class="form-group">
                                    <label> Description</label>
                                    <div>
                                        <textarea id="description" placeholder="Description"  name="description" rows="10">{{$service->description}}</textarea>
                                     </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
