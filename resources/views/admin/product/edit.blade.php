            ...
            <div class="page-title-box">
                ...
                <div class="state-information d-none d-sm-block">
                    <div class="state-graph">
                        ...
                        <div class="info"><a href="{{route('product.index')}}" class="btn btn-primary">Back</a></div>
                    </div>
                    <div class="state-graph">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input  name="name" type="text" value="{{$product->name}}"  class="form-control" id="name"  placeholder="Enter Title"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <textarea id="aboutEditor"  name="short_des" rows="10" placeholder="short Description">{{$product->short_des}}</textarea>
                                ...
                                <div class="form-group">
                                    <label>Price</label>
                                    <div>
                                        <input  name="price"  type="text" value="{{$product->price}}"  class="form-control"  placeholder="Enter price"/>
