    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card mb-20">
                <div class="card-body">
                    <form action="{{route('slider.update',$slider->id)}}" method="post" enctype="multipart/form-data" id="sliderForm">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label>Title</label>
                                    <div>
                                        <input  name="title" type="text" value="{{$slider->title}}"  class="form-control" id="name"  placeholder="Enter Title"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <textarea name="short_description"  class="form-control" cols="30" rows="3">{{$slider->short_description}}</textarea>
