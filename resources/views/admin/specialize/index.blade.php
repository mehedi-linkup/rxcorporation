    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                <h4 class="page-title">Specialize Table</h4>

                <div class="state-information d-none d-sm-block">
                    <div class="state-graph">
                        <div id="header-chart-1"></div>
                        <div class="info"><a href="{{route('specialize.create')}}" class="btn btn-primary">Add Specialize</a></div>
                    </div>
                    <div class="state-graph">
    ...
    <div class="row justify-content-center">
        <div class="col-lg-12">
            <div class="card m-b-20">
                <div class="card-body">
                    <h4 class="mt-0 header-title">Specialize Table</h4>
                    ...
                    <table id="example" class="table table-striped table-bordered table-responsive-md" style="width:100%">
                        ...
                        <tbody>
                            @foreach ($specialize as $key=> $item)
                            <tr class="text-center">
                                <td>{{$key+1}}</td>
                                ...
                                <td class="text-nowrap" width="10%">
                                    <a href="{{route('specialize.edit',$item->id)}}" class="btn btn-info"><i class="fas fa-edit"></i></a>
                                    <button type="submit" class="btn btn-primary" onclick="deleteUser({{ $item->id }})"><i class="fas fa-trash"></i></button>
                                    <form id="delete-form-{{ $item->id }}" action="{{ route('specialize.destroy', $item) }}"
