            ...
            <div class="page-title-box">
                ...
                <div class="state-information d-none d-sm-block">
                    <div class="state-graph">
                        ...
                        <div class="info"><a href="{{route('team.index')}}" class="btn btn-primary">Team List</a></div>
                    </div>
                    <div class="state-graph">
    ...
    <div class="row justify-content-center">
        <div class="col-lg-12">
            <div class="card m-b-20">
                <div class="card-body">
                    <form action="{{route('team.store')}}" method="post" enctype="multipart/form-data" id="managementForm">
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">
